            ...
            if (selectedDate === today.toISOString().split("T")[0]) {
	            ...
	            if (attendance != undefined) {
		            ...
		            btnIn.on('click', function() {
		                let serverDate = new Date(getCurrentTimeInISO8601());
		            	var btn = 0;
		                var atmgsts = 0;
		                // 현재 시간 표시
			                ...
			                // attendance가 정의된 경우 시간 정보 파싱
			                 var currentHour = parseInt(serverDate.toString().substring(16, 18)); //시간 18
			                var currentMinute = parseInt(serverDate.toString().substring(19, 21)); //분
