    ...
    */
    ...
    class CalendarDataManager {
        ...
        updateData() {
            ...
            console.log(data);
            let viewTitle = data.viewTitle;
            let titleArr = viewTitle.split(" ");
            if (titleArr[0] == "September") {
				data.viewTitle = titleArr[1] + "년 09월";
			} else if (titleArr[0] == "August") {
				data.viewTitle = titleArr[1] + "년 08월";
			} else if (titleArr[0] == "July") {
				data.viewTitle = titleArr[1] + "년 07월";
			}
